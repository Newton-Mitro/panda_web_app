...
class IconMediaSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Clean old uploads
        if ($disk->exists('uploads/icons')) {
            $disk->deleteDirectory('uploads/icons');
        }

        $sourceFolder = database_path('seeders/media/icons');
        ...
        foreach (array_values($files) as $index => $file) {
            ...
            $path = $disk->putFileAs('uploads/icons', new File($file), $fileName);
