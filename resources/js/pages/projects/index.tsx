        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-6">
                <div className="mb-4 flex flex-col items-start justify-between gap-2 sm:flex-row">
                    <HeadingSmall title="Projects" description="Manage your projects" />
                    <Link
                            ...
                            {projects.data.map((project) => (
                                ...
                                >
                                    ...
                                    <td className="px-2 py-1">
                                        ...
                                        <p className="text-gray-900 dark:text-gray-100">{project.title}</p>
                                    </td>
                                    <td className="px-2 py-1">
                                        <label className="font-semibold text-gray-700 md:hidden dark:text-gray-300">Category</label>
                                        <p className="text-gray-900 dark:text-gray-100">{project.category?.name || '-'}</p>
                                    </td>

                                    {/* Status */}
                                    <td className="px-2 py-1">
                                        <label className="font-semibold text-gray-700 md:hidden dark:text-gray-300">Status</label>
                                        <p className="text-gray-900 dark:text-gray-100">{project.status}</p>
                                    </td>
                ...
                <div className="mt-4 flex flex-col items-center justify-between gap-2 md:flex-row">
                    <span className="text-sm text-gray-600 dark:text-gray-400">Showing {projects.data.length} results</span>
