...
export default function Create({ categories, media }: CreateProps) {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        router.post(route('articles.store'), form, {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="h-[calc(100vh-100px)] space-y-8 overflow-auto p-6">
                <HeadingSmall title="Create Article" description="Write and publish a new article" />
                ...
                <form onSubmit={submit} className="space-y-6 rounded-lg border bg-white p-6 md:w-4xl dark:bg-gray-900">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Transition
                            ...
                            leaveTo="opacity-0"
                        >
                            <p className="text-sm text-neutral-600">Article created successfully 🎉</p>
                        </Transition>
                    </div>
                </form>
