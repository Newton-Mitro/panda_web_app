...
const Index: React.FC<ArticleProps> = ({ articles }) => {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-6">
                ...
                <div className="mb-4 flex flex-col items-start justify-between gap-2 sm:flex-row">
                    <HeadingSmall title="Articles" description="Manage your articles" />
                    <Link
                    ...
                    <table className="w-full border-collapse">
                        <thead className="sticky top-0 hidden bg-gray-50 md:table-header-group dark:bg-gray-800">
                            <tr>
                                ...
                                <th className="border-b border-gray-200 p-2 text-left dark:border-gray-700">Published At</th>
                            ...
                            {articles.data.map((article) => (
                                ...
                                >
                                    ...
                                    <td className="px-2 py-1">
                                        ...
                                        <p className="text-gray-900 dark:text-gray-100">{article.title}</p>
                                    </td>

                                    {/* Category */}
                                    <td className="px-2 py-1">
                                        <label className="font-semibold text-gray-700 md:hidden dark:text-gray-300">Category</label>
                                        <p className="text-gray-900 dark:text-gray-100">{article.category?.name || '-'}</p>
                                    </td>

                                    {/* Status */}
                                    <td className="px-2 py-1">
                                        <label className="font-semibold text-gray-700 md:hidden dark:text-gray-300">Status</label>
                                        <p className="text-gray-900 capitalize dark:text-gray-100">{article.status}</p>
                                    </td>

                                    {/* Published At */}
                                    <td className="px-2 py-1">
                                        <label className="font-semibold text-gray-700 md:hidden dark:text-gray-300">Published</label>
                ...
                <div className="mt-4 flex flex-col items-center justify-between gap-2 md:flex-row">
                    <span className="text-sm text-gray-600 dark:text-gray-400">Showing {articles.data.length} results</span>
