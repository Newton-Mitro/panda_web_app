...
const HeroSection = ({ heroImage, title, subtitle, quote }) => {
    ...
    return (
        <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background">
            ...
            <div className="absolute inset-0">
                <img src={heroImage} alt={`${appName} building`} className="h-full w-full object-cover opacity-80" />
            </div>
            ...
            <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
                <div className="mb-8">
                    ...
                    <h2 className="text-2xl font-light tracking-wider text-muted-foreground md:text-3xl">{subtitle}</h2>
                </div>

                {/* Quote */}
                <div className="mx-auto mb-12 max-w-2xl">
                    <blockquote className="text-lg leading-relaxed text-muted-foreground italic md:text-xl">{quote}</blockquote>
