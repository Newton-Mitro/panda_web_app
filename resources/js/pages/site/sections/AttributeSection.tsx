                ...
                <div className="flex flex-col gap-10">
                    <div className="group flex flex-col items-center group-hover:cursor-pointer md:relative md:flex-row">
                        <img
                            ...
                            className={`borderobject-cover z-10 mt-6 mb-6 h-72 w-72 border-6 bg-card shadow-lg transition-transform duration-300 group-hover:scale-105 md:h-96 md:w-96`}
