...
export default function Edit({ student, media, categories }: EditProps) {
    const [form, setForm] = useState({
        ...
        category_id: student.category_id || 0,
        birth_registration_no: student.birth_registration_no || '',
        national_id_no: student.national_id_no || '',
        address: student.address || '',
        media_id: student.media_id || null,
        status: student.status,
    });

    const [selectedMedia, setSelectedMedia] = useState<Media | null>(student.media || null);
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        router.put(route('students.update', student.id), form, {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: `Edit: ${student.first_name} ${student.last_name || ''}`, href: '' },
    ];
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="h-[calc(100vh-100px)] space-y-8 overflow-auto p-6">
                <HeadingSmall title="Edit Student" description={`Update student: ${student.first_name}`} />
                ...
                <form onSubmit={submit} className="space-y-6 rounded-lg border bg-white p-6 md:w-4xl dark:bg-gray-900">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        {recentlySuccessful && <p className="text-sm text-neutral-600">Updated</p>}
                    </div>
                </form>
