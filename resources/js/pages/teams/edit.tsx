...
export default function Edit({ team, categories, media }: EditProps) {
    const [form, setForm] = useState({
        ...
        pinterest_links: team.pinterest_links ?? '',
        tiktok_links: team.tiktok_links ?? '',
        snapchat_links: team.snapchat_links ?? '',
        whatsapp_links: team.whatsapp_links ?? '',
        telegram_links: team.telegram_links ?? '',
        github_links: team.github_links ?? '',
        discord_links: team.discord_links ?? '',
        email: team.email ?? '',
        phone: team.phone ?? '',
                ...
                <form onSubmit={submit} className="space-y-6 rounded-lg border bg-white p-6 shadow-md md:w-4xl dark:bg-gray-900">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                        {[
                            ...
                            { key: 'pinterest_links', label: 'Pinterest', placeholder: 'https://pinterest.com/username' },
                            { key: 'tiktok_links', label: 'TikTok', placeholder: 'https://tiktok.com/@username' },
                            { key: 'snapchat_links', label: 'Snapchat', placeholder: 'https://snapchat.com/add/username' },
                            { key: 'whatsapp_links', label: 'WhatsApp', placeholder: 'https://wa.me/1234567890' },
                            { key: 'telegram_links', label: 'Telegram', placeholder: 'https://t.me/username' },
